...
subword-nmt learn-bpe --input $data/preprocessed/train.fr --output $data/prepared/bpe_new/codes.fr --symbols 4000
subword-nmt learn-bpe --input $data/preprocessed/train.en --output $data/prepared/bpe_new/codes.en --symbols 4000
